...
interface WorkerProfile {
  id: string;
  name: string;
  category: "Architect" | "Plumber" | "Carpenter" | "Contractor" | "Electrician" | "Painter" | "Ceiling";
  role: string;
  experience: number;
  rating: number;
  reviewsCount: number;
    ...
    <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4 bg-black/75 backdrop-blur-md animate-fadeIn">
      <div className="bg-[#FAF8F5] rounded-3xl border border-[rgba(28,26,23,0.12)] max-w-md w-full p-6 shadow-2xl space-y-5">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {["Julian Vance (Carpenter)", "Elena Rostova (Architect)", "Marcus Sterling (Contractor)", "Vikramaditya Sharma (Plumber)"].map((p) => (
              <button
                key={p}
...
function generateFloorPlan(
  ...
  variant: number = 0,
  bhk: "1 BHK" | "2 BHK" | "3 BHK" | "4 BHK" = "2 BHK"
): Room[] {
  ...
  if (floorLevel === "first") {
    ...
    let bed2Label = wantsOffice ? "Children's Bedroom & Study Nook" : "Bedroom 2 (Upper Suite)";
    let masterLabel = "Primary Master Suite (Walk-in Closet)";
    let loungeLabel = "Upper Family TV Lounge & Media Den";

    if (bhkType === "1 BHK") {
      bed2Label = "Upper Creative Studio & Workspace";
      masterLabel = "Primary Master Sanctuary Suite";
      loungeLabel = "Upper Sunlit Reading Lounge";
    } else if (bhkType === "2 BHK") {
      bed2Label = wantsOffice ? "Children's Bedroom & Study Nook" : "Bedroom 2 (Upper Suite)";
      masterLabel = "Primary Master Suite (Walk-in Closet)";
    } else if (bhkType === "3 BHK") {
      bed2Label = wantsOffice ? "Bedroom 2 & Study Workstation" : "Bedroom 2 (Children Suite)";
      masterLabel = "Primary Master Suite (Bed 3 with En-suite)";
    } else if (bhkType === "4 BHK") {
      bed2Label = "Bedroom 3 (Upper Suite)";
      masterLabel = "Primary Master Suite (Bed 4 with Walk-in)";
      loungeLabel = "Bedroom 2 & Upper Lounge Den";
    }
    ...
    return [
      ...
      },
      {
        id: "ff-masterbath",
        type: "bath",
        label: "Master Bedroom Attached Washroom (En-suite)",
        x: pad + masterW,
        y: pad + balcH + loungeH,
        w: bathW,
        h: masterH,
        ...
        lightRating: "Soft",
        recommendedFurniture: [
          "Direct private master bedroom doorway (attached en-suite, zero corridor transit)",
        ...
        recommendedTrade: "Master Sanitary Plumber",
      },
      {
        id: "ff-bath2",
        type: "bath",
        label: bhkType === "1 BHK" ? "Upper Suite Attached Washroom (En-suite)" : "Bed 2 Attached Washroom (En-suite)",
        x: pad + masterW + bathW,
        y: pad + balcH + loungeH,
        ...
        lightRating: "Soft",
        recommendedFurniture: [
          "Direct private bedroom 2 doorway (attached en-suite access)",
          "Concealed wall-hung cistern WC with acoustic isolation",
  ...
  if (facing === "North") {
    ...
    let gfNorthBedLabel = floors > 1 ? "Guest Suite (Nairuthi SW)" : "Primary Master Suite (Nairuthi SW)";
    let gfNorthBathLabel = "Bedroom Attached Washroom (En-suite)";
    if (bhkType === "1 BHK") {
      gfNorthBedLabel = floors > 1 ? "Private Study Lounge (1 BHK)" : "Primary Master Suite (1 BHK Sanctuary)";
      gfNorthBathLabel = "Master Suite Attached Washroom (En-suite)";
    } else if (bhkType === "2 BHK") {
      gfNorthBedLabel = floors > 1 ? "Guest Suite / Bed 2 (Nairuthi SW)" : "Primary Master Suite (2 BHK Layout)";
      gfNorthBathLabel = floors > 1 ? "Bed 1 Attached Washroom (En-suite)" : "Master Suite Attached Washroom (En-suite)";
    } else if (bhkType === "3 BHK") {
      gfNorthBedLabel = floors > 1 ? "Bedroom 1 / Parents Suite (Nairuthi SW)" : "Primary Master Suite (3 BHK Layout)";
      gfNorthBathLabel = floors > 1 ? "Bed 1 Attached Washroom (Parents En-suite)" : "Master Suite Attached Washroom (En-suite)";
    } else if (bhkType === "4 BHK") {
      gfNorthBedLabel = floors > 1 ? "Ground Bedroom 1 (Parents Suite)" : "Primary Master Suite (4 BHK Layout)";
      gfNorthBathLabel = floors > 1 ? "Bed 1 Attached Washroom (Ground Suite En-suite)" : "Master Suite Attached Washroom (En-suite)";
    }
    ...
    rooms.push(
      ...
      },
      {
        ...
        lightRating: "Soft",
        recommendedFurniture: [
          "Direct private bedroom doorway (attached en-suite, zero corridor transit)",
          "Wall-hung floating double vanity with concealed German plumbing",
          "Thermostatic rainfall shower with frameless glass partition",
        ],
        paintHex: pal[0],
  ...
  if (facing === "East") {
    ...
    let eastBedLabel = floors > 1 ? "Guest Suite (Nairuthi SW)" : "Master Suite (Nairuthi SW)";
    let eastBathLabel = "Bedroom Attached Washroom (En-suite)";
    if (bhkType === "1 BHK") {
      eastBedLabel = floors > 1 ? "Private Study Lounge (1 BHK)" : "Primary Master Suite (1 BHK Sanctuary)";
      eastBathLabel = "Master Suite Attached Washroom (En-suite)";
    } else if (bhkType === "2 BHK") {
      eastBedLabel = floors > 1 ? "Guest Suite / Bed 2 (Nairuthi SW)" : "Primary Master Suite (2 BHK)";
      eastBathLabel = floors > 1 ? "Bed 1 Attached Washroom (Private En-suite)" : "Master Suite Attached Washroom (En-suite)";
    } else if (bhkType === "3 BHK") {
      eastBedLabel = floors > 1 ? "Bedroom 1 / Parents Suite (Nairuthi SW)" : "Primary Master Suite (3 BHK)";
      eastBathLabel = floors > 1 ? "Bed 1 Attached Washroom (Parents En-suite)" : "Master Suite Attached Washroom (En-suite)";
    } else if (bhkType === "4 BHK") {
      eastBedLabel = floors > 1 ? "Ground Bedroom 1 (Parents Suite)" : "Primary Master Suite (4 BHK)";
      eastBathLabel = floors > 1 ? "Bed 1 Attached Washroom (Ground Suite En-suite)" : "Master Suite Attached Washroom (En-suite)";
    }
    ...
    rooms.push(
      ...
      },
      {
        ...
        lightRating: "Soft",
        recommendedFurniture: [
          "Direct private bedroom doorway (attached en-suite configuration, zero corridor transit)",
  ...
  if (facing === "South") {
    ...
    let southBedLabel = floors > 1 ? "Quiet Garden Suite (North Rear)" : "Primary Suite (Quiet Garden Rear)";
    let southBathLabel = "Bedroom Attached Washroom (En-suite)";
    if (bhkType === "1 BHK") {
      southBedLabel = floors > 1 ? "Private Garden Study (1 BHK)" : "Primary Master Suite (1 BHK Sanctuary)";
      southBathLabel = "Master Suite Attached Washroom (En-suite)";
    } else if (bhkType === "2 BHK") {
      southBedLabel = floors > 1 ? "Guest Suite / Bed 2 (Garden Rear)" : "Primary Master Suite (2 BHK)";
      southBathLabel = floors > 1 ? "Bed 1 Attached Washroom (Garden En-suite)" : "Master Suite Attached Washroom (En-suite)";
    } else if (bhkType === "3 BHK") {
      southBedLabel = floors > 1 ? "Bedroom 1 / Parents Garden Suite" : "Primary Master Suite (3 BHK)";
      southBathLabel = floors > 1 ? "Bed 1 Attached Washroom (Parents Garden En-suite)" : "Master Suite Attached Washroom (En-suite)";
    } else if (bhkType === "4 BHK") {
      southBedLabel = floors > 1 ? "Ground Bedroom 1 (Garden Suite)" : "Primary Master Suite (4 BHK)";
      southBathLabel = floors > 1 ? "Bed 1 Attached Washroom (Ground Suite En-suite)" : "Master Suite Attached Washroom (En-suite)";
    }
    ...
    rooms.push(
      ...
      },
      {
        ...
        lightRating: "Soft",
        recommendedFurniture: [
          "Direct private bedroom doorway (private en-suite attached access, zero corridor transit)",
  ...
  let westBedLabel = floors > 1 ? "Private Guest Suite (Nairuthi SW)" : "Primary Master Suite (Nairuthi SW)";
  let westBathLabel = "Bedroom Attached Washroom (En-suite)";
  if (bhkType === "1 BHK") {
    westBedLabel = floors > 1 ? "Private Study Lounge (1 BHK)" : "Primary Master Suite (1 BHK Sanctuary)";
    westBathLabel = "Master Suite Attached Washroom (En-suite)";
  } else if (bhkType === "2 BHK") {
    westBedLabel = floors > 1 ? "Guest Suite / Bed 2 (Nairuthi SW)" : "Primary Master Suite (2 BHK)";
    westBathLabel = floors > 1 ? "Bed 1 Attached Washroom (Private En-suite)" : "Master Suite Attached Washroom (En-suite)";
  } else if (bhkType === "3 BHK") {
    westBedLabel = floors > 1 ? "Bedroom 1 / Parents Suite (Nairuthi SW)" : "Primary Master Suite (3 BHK)";
    westBathLabel = floors > 1 ? "Bed 1 Attached Washroom (Parents En-suite)" : "Master Suite Attached Washroom (En-suite)";
  } else if (bhkType === "4 BHK") {
    westBedLabel = floors > 1 ? "Ground Bedroom 1 (Parents Suite)" : "Primary Master Suite (4 BHK)";
    westBathLabel = floors > 1 ? "Bed 1 Attached Washroom (Ground Suite En-suite)" : "Master Suite Attached Washroom (En-suite)";
  }
  ...
  rooms.push(
    ...
    },
    {
      ...
      lightRating: "Soft",
      recommendedFurniture: [
        "Direct private bedroom doorway (private en-suite attached configuration, zero corridor transit)",
...
function AIPlannerSection({
  ...
  const handleSavePlan = async () => {
    ...
    try {
      await housePlanApi.savePlan({
        title: `Bespoke ${inputs.style} ${inputs.bhk || "2 BHK"} ${inputs.floors}-Floor Residence`,
        inputs,
        rooms: result.rooms,
    ...
    <section id="planner" className="py-24 px-4 md:px-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 bg-[#FAF8F5] p-6 md:p-8 rounded-3xl border border-[rgba(28,26,23,0.08)] shadow-sm space-y-5">
          ...
          {/* House Typology / BHK Requirements: 1 BHK, 2 BHK, 3 BHK, 4 BHK */}
          <div>
            <div className="flex items-center justify-between mb-1.5">
              <label className="text-xs font-semibold text-[#5E5851] flex items-center gap-1.5">
                <span>BHK Requirement</span>
                <span className="text-[10px] text-[#968F85] font-normal font-sans">(Bed, Hall, Kitchen)</span>
              </label>
              <span className="text-[10px] font-bold text-[#B88555] bg-[#FAF3EC] px-2 py-0.5 rounded-md border border-[#B88555]/20">
                {inputs.bhk || "2 BHK"} Selected
              </span>
            </div>
            <div className="grid grid-cols-4 gap-2">
              {[
                { label: "1 BHK", desc: "1 Bed • 1 Attached Bath" },
                { label: "2 BHK", desc: "2 Beds • 2 Attached Baths" },
                { label: "3 BHK", desc: "3 Beds • 3 Attached Baths" },
                { label: "4 BHK", desc: "4 Beds • 4 Attached Baths" },
              ].map((item) => {
                const isSelected = (inputs.bhk || "2 BHK") === item.label;
                return (
                  <button
                    key={item.label}
                    type="button"
                    onClick={() => {
                      let autoFam = inputs.familySize;
                      if (item.label === "1 BHK" && parseInt(inputs.familySize) > 2) autoFam = "2";
                      if (item.label === "3 BHK" && parseInt(inputs.familySize) < 3) autoFam = "4";
                      if (item.label === "4 BHK" && parseInt(inputs.familySize) < 4) autoFam = "5";
                      setInputs({ ...inputs, bhk: item.label as any, familySize: autoFam });
                    }}
                    className={`py-2 px-1 rounded-xl text-center border transition-all cursor-pointer ${
                      isSelected
                        ? "bg-[#1C1A17] text-white border-[#1C1A17] shadow-sm font-semibold ring-1 ring-[#1C1A17]"
                        : "bg-white text-[#5E5851] border-[rgba(28,26,23,0.15)] hover:border-[#1C1A17] hover:text-[#1C1A17]"
                    }`}
                  >
                    <div className="text-xs font-bold leading-tight">{item.label}</div>
                    <div className={`text-[9px] mt-0.5 ${isSelected ? "text-white/70" : "text-[#968F85]"}`}>
                      {item.desc}
                    </div>
                  </button>
                );
            ...
            {/* 100% En-Suite Attached Washrooms Guarantee Badge */}
            <div className="mt-2 flex items-start gap-1.5 text-[10.5px] text-emerald-950 bg-emerald-50/90 border border-emerald-200/80 rounded-xl p-2 shadow-xs">
              <span className="font-bold text-emerald-700 flex items-center gap-1 flex-shrink-0 mt-0.5">
                <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
                100% En-Suite:
              </span>
              <span className="text-emerald-800 leading-tight">
                Every bedroom features its own direct attached washroom (zero common/separate baths).
              </span>
            </div>
          </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-bold px-2.5 py-0.5 rounded-full bg-[#FAF3EC] text-[#B88555] border border-[#B88555]/25">
                        🏡 {inputs.bhk || "2 BHK"}
                      </span>
                        ...
                        <div className="flex flex-wrap items-center gap-2 mt-1">
                          {selectedRoom.type === "bath" && (
                            <span className="text-[10px] font-bold px-2 py-0.5 rounded-md bg-emerald-100 text-emerald-800 border border-emerald-200 flex items-center gap-1">
                              🔒 100% Private Attached Washroom (En-Suite)
                            </span>
                          )}
                          {selectedRoom.type === "bedroom" && (
                            <span className="text-[10px] font-bold px-2 py-0.5 rounded-md bg-[#FAF3EC] text-[#B88555] border border-[#B88555]/25 flex items-center gap-1">
                              🚿 Direct Attached Washroom Connected
                            </span>
                          )}
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                      <button
                        ...
                        className="px-3.5 py-2 rounded-full bg-white/15 hover:bg-white/25 text-white text-xs font-semibold transition-all flex items-center gap-1.5 flex-shrink-0"
                        title="Save plan to MongoDB cloud database"
                      >
                        <span>{saveStatus === "saving" ? "Saving..." : saveStatus === "saved" ? "✓ Saved to Cloud" : "Save Plan ☁"}</span>
                      </button>
                      <button
...
function WorkforceSection({
  ...
  const [roster, setRoster] = useState<WorkerProfile[]>(WORKFORCE_ROSTER);

  useEffect(() => {
    workerApi
      .getWorkers({ category: filter !== "All" ? filter : undefined })
      .then((data) => {
        if (data?.success && Array.isArray(data.workers) && data.workers.length > 0) {
          const mapped: WorkerProfile[] = data.workers.map((w: any) => ({
            id: w.workerId || w.id || w._id,
            name: w.name,
            category: w.category,
            role: w.role,
            ...
            dayRate: w.dayRate,
            location: w.location,
            avatar: w.avatar || WORKFORCE_ROSTER[0].avatar,
            verified: w.verified !== false,
            specialties: w.specialties || [],
            recentProject: w.recentProject || "",
            bio: w.bio || "",
          }));
          setRoster(mapped);
        }
      ...
      .catch(() => {
        // Keeps default WORKFORCE_ROSTER on offline
      });
  }, [filter]);

  const filtered = filter === "All" ? roster : roster.filter((w) => w.category === filter);
  ...
  return (
    <section id="workforce" className="py-24 px-4 md:px-8 max-w-7xl mx-auto border-t border-[rgba(28,26,23,0.1)]">
      ...
      <div className="flex flex-wrap gap-2 mb-8">
        {["All", "Architect", "Plumber", "Carpenter", "Contractor", "Electrician", "Painter", "Ceiling"].map((f) => (
          <button
            key={f}
            onClick={() => setFilter(f)}
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await bookingApi.createBooking({
        ...
        workerRole: current.role,
        workerCategory: current.category,
        days,
        dayRate: current.dayRate,
        scopeContext: context,
      });
      if (res?.booking?.bookingRef) {
        setBookingRef(res.booking.bookingRef);
      } else {
        setBookingRef(`AURA-IN-${Math.floor(100000 + Math.random() * 900000)}`);
      }
    } catch {
      setBookingRef(`AURA-IN-${Math.floor(100000 + Math.random() * 900000)}`);
    } finally {
        ...
        {!submitted ? (
          <form onSubmit={handleSubmit} className="space-y-4 text-xs">
            ...
            <button
              ...
              className="w-full py-3.5 bg-[#B88555] hover:bg-[#A07144] text-white rounded-xl font-semibold text-sm transition-all shadow-md active:scale-98 disabled:opacity-75"
            >
              {isSubmitting ? "Locking Consultation..." : "Confirm Consultation Booking ↗"}
            </button>
          </form>
        ) : (
          <div className="py-6 text-center space-y-3">
            ...
            <div className="p-3 bg-[#EFECE6] rounded-xl text-xs font-mono max-w-xs mx-auto text-left">
              Ref: #{bookingRef || `AURA-IN-${Math.floor(100000 + Math.random() * 900000)}`} • Total: ₹{total.toLocaleString("en-IN")}
            </div>
            <button
              onClick={onClose}
...
// ─── AUTH MODAL: Firebase Authentication ──────────────────────────────────────
function AuthModal({
  isOpen,
  onClose,
  onUserAuth,
  ...
  return (
    <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4 bg-black/75 backdrop-blur-md animate-fadeIn">
      <div className="bg-[#FAF8F5] rounded-3xl border border-[rgba(28,26,23,0.12)] max-w-sm w-full p-6 shadow-2xl space-y-5">
        <div className="flex items-center justify-between pb-3 border-b border-[rgba(28,26,23,0.08)]">
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 rounded-md bg-[#1C1A17] text-white flex items-center justify-center text-xs font-bold">✦</div>
            <h3 className="font-display font-bold text-lg text-[#1C1A17]">
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-2.5 px-4 rounded-xl border border-[rgba(28,26,23,0.15)] bg-white hover:bg-[#FAF8F5] transition-all flex items-center justify-center gap-2 text-xs font-semibold text-[#1C1A17] shadow-xs active:scale-98"
        >
        ...
        <div className="flex items-center gap-3">
          <div className="h-px bg-[rgba(28,26,23,0.1)] flex-1" />
          <span className="text-[10px] uppercase font-bold text-[#968F85]">or with email</span>
          <div className="h-px bg-[rgba(28,26,23,0.1)] flex-1" />
        </div>
        ...
        <form onSubmit={handleEmailSubmit} className="space-y-3 text-xs">
          {isSignUp && (
            <div>
              ...
              <input
                ...
                value={name}
                onChange={(e) => setName(e.target.value)}
                className="w-full bg-white border border-[rgba(28,26,23,0.15)] rounded-xl p-2.5 text-[#1C1A17] focus:outline-none focus:border-[#B88555]"
              />
            </div>
          )}

          <div>
            <label className="font-bold text-[#5E5851] block mb-1">Email Address</label>
            <input
              type="email"
              required
              placeholder="client@auraspaces.com"
              value={email}
              onChange={(e) => setEmail(e.target.value)}
              className="w-full bg-white border border-[rgba(28,26,23,0.15)] rounded-xl p-2.5 text-[#1C1A17] focus:outline-none focus:border-[#B88555]"
            />
          ...
          <div>
            <label className="font-bold text-[#5E5851] block mb-1">Password</label>
            <input
              type="password"
              required
              placeholder="••••••••"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2.5 bg-[#28362B] hover:bg-[#1E2B22] text-white rounded-xl font-semibold text-xs transition-all shadow-md active:scale-98 disabled:opacity-60"
          >
            {loading ? "Authenticating..." : isSignUp ? "Create Account ↗" : "Sign In ↗"}
          </button>
        </form>

        <div className="pt-2 text-center text-xs text-[#5E5851]">
          ...
          <button
            ...
            className="text-[#B88555] font-semibold hover:underline ml-1"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-white/70">
              ...
              <li><a href="#workforce" className="hover:text-white">Whole-Building Sanitary Plumbers</a></li>
            </ul>
          </div>
